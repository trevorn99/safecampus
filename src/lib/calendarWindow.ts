// Shared by every page that renders <EventCalendar> — one month back, two
// months forward, with a bit of padding either side so Prev/Next always
// have somewhere to go without a fresh fetch.
